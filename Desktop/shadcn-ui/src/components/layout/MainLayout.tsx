...
const getRoleNavItems = (role: UserRole): { icon: ReactNode; label: string; href: string }[] => {
  const baseNavItems = [
    ...
    { icon: <Dumbbell size={20} />, label: 'Classes & Programs', href: '/classes' },
    ...
    { icon: <Calendar size={20} />, label: 'My Bookings', href: '/my-bookings' },
  ...
  if (role === 'admin') {
    return [
      ...baseNavItems,
      { icon: <User size={20} />, label: 'User Management', href: '/admin/users' },
      { icon: <Crown size={20} />, label: 'Content Management', href: '/admin/content' },
    ];
  }
  ...
  if (role === 'gym') {
    return [
      ...baseNavItems,
      { icon: <Dumbbell size={20} />, label: 'Manage Classes', href: '/gym/manage-classes' },
      { icon: <Users size={20} />, label: 'Check-ins', href: '/gym/check-ins' },
    ];
  }

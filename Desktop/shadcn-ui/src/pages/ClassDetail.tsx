...
export default function ClassDetail() {
  ...
  useEffect(() => {
    const fetchClassDetails = async () => {
      ...
      try {
        ...
        toast({
          title: "Error",
          description: "There was an error fetching the class details.",
          variant: "destructive"
        });
      } finally {
        setIsLoading(false);
  ...
  const completeBooking = () => {
    ...
    toast({
      ...
      description: `You have successfully booked ${classDetails?.title}.`,
    });
  };
  ...
  const coachData = mockCoaches.find(c => c.email === classDetails.coach.email || c.name === classDetails.coach.name) || classDetails.coach;
    ...
    <div className="space-y-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="relative z-10">
              <ShareButton
                url={`${window.location.origin}/classes/${classDetails.id}`}
                title={`Check out ${classDetails.title} on SportFlare`}
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-2">
                    <div className="font-medium">{classDetails.price} TND</div>
                  </div>
                </div>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div className="space-y-1">
                        <div className="flex items-center gap-2">
                          ...
                          <div className="flex">
                            {[...Array(5)].map((_, i) => (
                              <Star key={i} className={`h-3 w-3 ${i < 5 ? 'fill-yellow-500 text-yellow-500' : 'text-muted'}`} />
                            ))}
                          </div>
                        </div>
                        <p className="text-sm text-muted-foreground">2 weeks ago</p>
                        <p className="text-sm">
                          This class was amazing! The instructor was very knowledgeable and supportive.
                          I felt challenged but not overwhelmed. Will definitely be coming back!
                        </p>
                      </div>
                    </div>
                  </CardContent>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div className="space-y-1">
                        <div className="flex items-center gap-2">
                          ...
                          <div className="flex">
                            {[...Array(5)].map((_, i) => (
                              <Star key={i} className={`h-3 w-3 ${i < 4 ? 'fill-yellow-500 text-yellow-500' : 'text-muted'}`} />
                            ))}
                          </div>
                        </div>
                        <p className="text-sm text-muted-foreground">1 month ago</p>
                        <p className="text-sm">
                          Great workout! I appreciated how the instructor offered modifications for different fitness levels.
                          The music selection was also fantastic.
                        </p>
                      </div>
                    </div>
                  </CardContent>
        ...
        <div className="space-y-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <Button variant="outline" className="w-full" onClick={() => setIsCoachDialogOpen(true)}>View Profile</Button>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <Button variant="outline" className="w-full" onClick={() => handleViewGym(classDetails.gym)}>View Gym</Button>
            </CardContent>
          </Card>
              ...
              <CardContent className="space-y-4">
                {similarClasses.map((similarClass) => (
                  <div key={similarClass.id} className="flex items-start gap-3 pb-3 last:pb-0 last:border-0 border-b">
                    ...
                    <div className="text-sm font-medium">{similarClass.price} TND</div>
                  </div>
                ))}
              </CardContent>
              <CardFooter>
      ...
      {coachData && (
        <PrivateSessionBookingModal
          ...
          coachPrice={coachData.hourlyRate}

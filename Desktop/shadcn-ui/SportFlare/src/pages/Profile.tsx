                        ...
                        <div>
                          ...
                          <div className="text-sm text-muted-foreground">
                            <p className="flex items-center gap-2">
                              <span>Plan: <span className="font-medium text-foreground capitalize">{user.subscription.plan}</span></span>
                            </p>
                            <p>Valid until: {formatDate(new Date(user.subscription.endDate))}</p>
                            <p>Auto-renew: {user.subscription.autoRenew ? 'Yes' : 'No'}</p>
                          </div>
                        </div>
                      )}
                    </>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <Card className="border-2 border-muted">
                  ...
                  <CardContent>
                    ...
                    <ul className="space-y-2 text-sm">
                      <li className="flex items-center gap-2">
                        <span className="text-green-500">✓</span> Track workouts
                      </li>
                      <li className="flex items-center gap-2">
                        <span className="text-green-500">✓</span> Browse classes
                      </li>
                      <li className="flex items-center gap-2">
                  ...
                  <CardFooter>
                    <Button variant="ghost" className="w-full">Current Plan</Button>
                  </CardFooter>
                </Card>
                ...
                <Card className="border-2 border-primary">
                  ...
                  <CardContent>
                    <div className="text-2xl font-bold mb-4">$9.99<span className="text-sm font-normal">/month</span></div>
                    <ul className="space-y-2 text-sm">
                      <li className="flex items-center gap-2">
                        <span className="text-green-500">✓</span> All Free features
                      </li>
                      <li className="flex items-center gap-2">
                        <span className="text-green-500">✓</span> AI coaching
                      </li>
                      <li className="flex items-center gap-2">
                        <span className="text-green-500">✓</span> Advanced analytics
                      </li>
                      <li className="flex items-center gap-2">
                        <span className="text-green-500">✓</span> Workout plans
                      </li>
                    </ul>
                  </CardContent>
                  <CardFooter>
                ...
                <Card className="border-2 border-muted">
                  <CardHeader>
                    ...
                    <CardDescription>For serious athletes</CardDescription>
                  </CardHeader>
                  <CardContent>
                    ...
                    <ul className="space-y-2 text-sm">
                      ...
                      <li className="flex items-center gap-2">
                        <span className="text-green-500">✓</span> 1-on-1 coaching
                      </li>
                      <li className="flex items-center gap-2">
                        <span className="text-green-500">✓</span> Custom nutrition plans
                      </li>
                      <li className="flex items-center gap-2">
